...
import fullprint from "@/assets/fullprint-odonto.png";

const PreviewOdonto = () => {
  useEffect(() => {
    document.title = "Preview — Odonto | Notch";
  }, []);
        ...
        >
          <div className="w-[250px] h-[540px] md:w-[280px] md:h-[600px] bg-zinc-900 rounded-[30px] border-[10px] border-black shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 overflow-y-auto">
              <img
                src={fullprint}
                alt="Preview completo do projeto — Odonto"
                loading="lazy"
